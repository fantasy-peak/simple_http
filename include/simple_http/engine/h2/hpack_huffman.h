...
namespace simple_http::codec
{
    ...
    // Definitions are inline at the bottom of this header (header-only).
    inline int http_huffman_decode_bits(unsigned char *state, unsigned char *ending, unsigned int bits, std::string &dst);
    inline int http_huffman_decode(unsigned char *state, unsigned char *src, size_t len, std::string &outstr, unsigned int last);
    inline int http_huffman_encode(unsigned char *src, unsigned int len, std::string &outstr);

    inline const huffman_static_encode_t huffman_encode_table[] = {
    ...
    inline const http_huffman_decode_code_t http_huffman_decode_tables[256][16] =
    {
        /* 0 */
        {
    ...
    inline int http_huffman_decode_bits(unsigned char *state, unsigned char *ending, unsigned int bits, std::string &outstr)
    {
